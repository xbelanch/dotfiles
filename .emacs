...
;; Multiple cursors
;; @BUG: Thrown warnings since last update!
...
;; Emacs search words with underscores considered as word boundaries
;; or how to make forward-word, backward-word, treat underscore as part of a word
